...
class AcsfCommand extends BltTasks {
  ...
  public function acsfInitialize($options = ['acsf-version' => '^2.47.0']) {
    ...
    $this->taskExecStack()
      ...
      ->exec("ls -ltr; ./home/travis/build/lcatlett/blt/vendor/bin/cachetool opcache:status; ../home/travis/build/lcatlett/blt/vendor/bin/cachetool  apcu:cache:info; ./home/travis/build/lcatlett/blt/vendor/bin/cachetool stat:realpath_get; ./home/travis/build/lcatlett/blt/vendor/bin/cachetool  stat:realpath_size")
      ->run();
